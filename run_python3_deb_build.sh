...
./docker_scripts/build_python3_deb.sh git+https://github.com/ddboline/numpy.git@v1.11.0-1
...
./docker_scripts/build_python3_deb.sh records dask-array validictory pydrive hypothesis
