...
sudo apt-get update
sudo apt-get install -y postgresql-server-dev-9.3 libhdf5-dev libxml2-dev libxslt1-dev libpython3.4-dev
...
./docker_scripts/build_python3_deb.sh git+https://github.com/ddboline/py2deb.git@0.24.3.1
...
./docker_scripts/build_python3_deb.sh git+https://github.com/ddboline/compose.git@1.9.0-rc4-1
