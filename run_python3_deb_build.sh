...
sudo apt-get update
sudo apt-get install -y postgresql-server-dev-10 libhdf5-dev libxml2-dev libxslt1-dev libpython3.5-dev \
...
if [ -n "$MODIFIED" ]; then
    scp $MODIFIED build.log ddboline@home.ddboline.net:/home/ddboline/setup_files/deb/py2deb3/py2deb3/
fi
