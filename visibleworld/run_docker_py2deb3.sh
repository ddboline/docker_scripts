...
echo "$@"
$SUDO docker run --rm --name=py2deb3_${D} \
        ...
        /home/ubuntu/docker_scripts/visibleworld/run_python3_deb_build.sh \
        2>&1 > /home/ddboline/setup_files/deb/py2deb3/py2deb3/solver.log
