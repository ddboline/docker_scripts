...
./docker_scripts/build_python_deb.sh git+https://github.com/paylogic/pip-accel.git@pip-8.1-upgrade
...
./docker_scripts/build_python_deb.sh git+https://github.com/ddboline/scipy.git@v0.18.0-1
...
./docker_scripts/build_python_deb.sh git+https://github.com/ddboline/compose.git@1.8.0-1
