...
./docker_scripts/build_python_deb.sh git+https://github.com/pypa/pip.git@8.1.2
./docker_scripts/build_python_deb.sh git+https://github.com/ddboline/pip-accel.git@pip-8.1-upgrade
...
./docker_scripts/build_python_deb.sh git+https://github.com/ddboline/compose.git@1.8.1-1
